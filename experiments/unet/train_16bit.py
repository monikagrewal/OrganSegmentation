...
def main():
    ...
    train_dataloader = DataLoader(train_dataset, shuffle=True, batch_size=batchsize, num_workers=10)
    val_dataloader = DataLoader(val_dataset, shuffle=False, batch_size=batchsize, num_workers=10)
